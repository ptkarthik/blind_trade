...
for line in lines:
    ...
    if len(parts) >= 3:
        ...
        industry = parts[1]
        symbol = parts[2]
        # Map industry to sector roughly
        sector = "Others"
        ind = industry.upper()
        if "BANK" in ind or "FINANCIAL" in ind: sector = "Banking"
        elif "IT" in ind or "SOFTWARE" in ind or "TECHNOL" in ind: sector = "IT"
        elif "AUTO" in ind: sector = "Auto"
        elif "PHARMA" in ind or "HEALTH" in ind: sector = "Pharma"
        elif "ENERGY" in ind or "POWER" in ind or "OIL" in ind: sector = "Energy"
        elif "CONSUMER" in ind or "GOODS" in ind or "FMCG" in ind: sector = "FMCG"
        elif "METAL" in ind or "STEEL" in ind: sector = "Metal"
        elif "CONSTRUCTION" in ind or "INFRA" in ind: sector = "Infrastructure"
        elif "TEXTILE" in ind: sector = "Textiles"
        elif "CHEMICAL" in ind: sector = "Chemicals"
        elif "SERVICES" in ind: sector = "Services"
